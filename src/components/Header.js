...
const Header = () => (
      ...
      <div>
          <div className="media"><img src="https://image.flaticon.com/icons/png/512/21/21294.png" style={{ borderRadius: "50%", marginLeft: "auto", marginRight: "auto", marginTop: "50px", marginBottom: "76px", width: "200px", height: "200px" }}></img></div>
          <h1 className="text-center" style={{ color: "#fff", fontSize: "36px", fontWeight: 700 }}>Ian Waweru Kamau</h1>
          <h3 className="text-center text-capitalize" style={{ color: "#fff", marginTop: "20px", fontSize: "24px", fontWeight: 400 }} >Full Stack Web Developer</h3>
